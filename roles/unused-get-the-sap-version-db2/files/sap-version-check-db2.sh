...
echo "$sid" > /tmp/$sidadm-sap-version-check-db2.log
echo "$sapvers" >> /tmp/$sidadm-sap-version-check-db2.log
disp+work|egrep -i 'variant|number' >> /tmp/$sidadm-sap-version-check-db2.log
echo "$dblevel" >> /tmp/$sidadm-sap-version-check-db2.log