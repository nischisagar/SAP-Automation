...
echo "$sid" > /tmp/$i-sap-version-check-s4hana.log
echo "$sapvers" >> /tmp/$i-sap-version-check-s4hana.log
echo "$kernellevel" >>  /tmp/$i-sap-version-check-s4hana.log
echo "HANA $hdblevel" >>  /tmp/$i-sap-version-check-s4hana.log
echo "$dbsize" >> /tmp/$i-sap-version-check-s4hana.log
done
